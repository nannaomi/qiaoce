<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"C:\wamp\www\qiaoce\public/../application/admin\view\joinus\recruitedit.html";i:1551776944;s:70:"C:\wamp\www\qiaoce\public/../application/admin\view\public\header.html";i:1551775589;s:70:"C:\wamp\www\qiaoce\public/../application/admin\view\public\footer.html";i:1551776944;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
	...
	<form action="" method="post" class="form form-horizontal" id="form">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $data['name']; ?>" placeholder="请输入职称" id="name" name="name">
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<script id="editor" type="text/plain" style="width:100%;height:400px;" name="content" ><?php echo $data['content']; ?></script>
			</div>
			<script type="text/javascript">
