<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"C:\wamp\www\qiaoce\public/../application/admin\view\background\background.html";i:1551776943;s:70:"C:\wamp\www\qiaoce\public/../application/admin\view\public\header.html";i:1551775589;s:70:"C:\wamp\www\qiaoce\public/../application/admin\view\public\footer.html";i:1551776944;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
			...
			<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$vo): ?>
				<tr class="text-c">
					...
					<td class="f-14 product-brand-manage">
						<a style="text-decoration:none" onclick="synopsis_edit('编辑','<?php echo url('backgroundEdit',array('id'=>$vo['id'])); ?>','','','800')" href="javascript:;" title="编辑">
							<i class="Hui-iconfont">&#xe6df;</i>
						</a>
