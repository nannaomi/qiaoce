<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"C:\wamp\www\new\public/../application/admin\view\background\backgroudadd.html";i:1541743763;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
    ...
    <form action="" method="post" class="form form-horizontal" id="formadd">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="最多允许输入4个字符" id="title" name="name">
            </div>
        </div>
        <div class="row cl">
