<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"C:\wamp\www\new\public/../application/admin\view\article\article.html";i:1542246564;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
	        ...
	        <a class="btn btn-primary radius" data-title="添加资讯" onClick="article_add('添加资讯','article_add.html','10001')" href="javascript:;">
		...
		<table class="table table-border table-bordered table-bg table-hover table-responsive">
			...
			<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$vo): ?>
				<tr class="text-c">
					...
					<td><img height="80" class="picture-thumb" src="__IMG__/content/<?php echo $vo['thumb_img']; ?>"></a></td>
					...
					<td class="f-14 td-manage"><a style="text-decoration:none" onClick="article_stop(this,'10001')" href="javascript:;" title="下架">
						...
						<a style="text-decoration:none" class="ml-5" onClick="article_edit('资讯编辑','<?php echo url('article_edit',array('id'=>$vo['id'])); ?>','10001')" href="javascript:;" title="编辑">
							<i class="Hui-iconfont">&#xe6df;</i></a>
