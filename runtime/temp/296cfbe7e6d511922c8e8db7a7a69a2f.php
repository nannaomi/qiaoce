<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"C:\wamp\www\qiaoce\public/../application/admin\view\index\index.html";i:1551663844;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					...
					<li><a data-href="<?php echo url('pictureother/index'); ?>" data-title="项目管理" href="javascript:void(0)">项目管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-product">
	...
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="登录" data-href="welcome.html">登录</span>
					<em></em></li>
		</ul>
	</div>
