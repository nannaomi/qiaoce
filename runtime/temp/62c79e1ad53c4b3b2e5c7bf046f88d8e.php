<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"C:\wamp\www\qiaoce\public/../application/admin\view\business\pictureadd.html";i:1551778536;s:70:"C:\wamp\www\qiaoce\public/../application/admin\view\public\header.html";i:1551775589;s:70:"C:\wamp\www\qiaoce\public/../application/admin\view\public\footer.html";i:1551776944;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
	<form class="form form-horizontal" id="business_add">

		<div class="row cl">

			<input type="hidden" id="image_url" name="image_url" value="" />
			<input type="hidden" id="cid"  value="<?php echo $parm['cid']; ?>" />
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button onClick="photoAdd()" class="btn btn-primary radius" type="button"><i class="Hui-iconfont">&#xe632;</i> 保存并发布</button>
...
<script type="text/javascript">
    function photoAdd(){
        ...
        $.ajax({
            type:'POST',
            url:"<?php echo url('business/imgAdd'); ?>",
            data:{'cid':cid,'imgUrl':image_url},
            dataType: 'json',
    ...
    //        var form = document.getElementById("business_add");
    //        var fd = new FormData(form);
    //       $.ajax({
    //           type: 'POST',
    //           url: '<?php echo url("admin/business/upload"); ?>',
    //           data: fd,
    //           success: function(json){
    //               console.log(json);
    //               layer.msg(json,{icon:2,time:1500});
    ...
    (function( $ ){
        ...
        $(function() {
            ...
            uploader = WebUploader.create({
                ...
                chunked: false,
                chunkSize: 512 * 1024,
                server: '<?php echo url("admin/business/upload"); ?>',
                // runtimeOrder: 'flash',
                // accept: {
                //     title: 'Images',
            ...
            uploader.on('uploadSuccess',function(file,response){
                var imgurl = eval(response)._raw; //上传图片的路径
                $("#image_url").each(function(){  //使用foreach 循环 地址
                    arr.push(imgurl);   //地址追加进数组
                });
                $("#image_url").val(arr); //将地址写入到form表单
            });
