<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"C:\wamp\www\qiaoce\public/../application/admin\view\pictureother\pictureother.html";i:1551334924;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
			...
			<tbody>
			  <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$data): ?>
				<tr class="text-c">
					...
					<td class="td-manage">
						<a style="text-decoration:none" class="ml-5" onclick="product_edit('编辑','<?php echo url('proEdit',array('id'=>$data['id'])); ?>','800')" href="javascript:;" title="编辑">
